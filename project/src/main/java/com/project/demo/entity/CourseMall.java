...
/**
 * 课程商城：(CourseMall)表实体类
 *
 */
@TableName("`course_mall`")
@Data
@EqualsAndHashCode(callSuper = false)
public class CourseMall implements Serializable {

    // CourseMall编号
    @TableId(value = "course_mall_id", type = IdType.AUTO)
    private Integer course_mall_id;
